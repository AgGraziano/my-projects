...
defaultTest = pd.read_csv("\data\test.csv")                # Importing the dataframe 'test.csv' from the appropriate folder
defaultTrain = pd.read_csv("\data\train.csv")              # Importing the dataframe 'train.csv' from the appropriate folder
